  ...
  <div class="mealItem" ref="mealItem">
    <item :leftFlex="1.78" class="itemx">
      <img
        src=""
        class="img"
        :class="{ goRight: hasGoRight }"
        slot="left"
        alt=""
        srcset=""
      />
      <div
        class="flexColArd cover marginLeft30"
        :class="{ goLeft: hasGoLeft }"
        slot="right"
      >
        ...
        <div class="serviceCount font12 gray">
          <div class="flexBew">
            ...
            <el-tag effect="dark" class="font14 marginRight40">企业团餐</el-tag>
          </div>
        </div>
        <div class="tag font12 lightBlue">起订份20份</div>
        <div class="flexBew">
          <el-tag type="warning" effect="light">asdas</el-tag>
          <div class="font12 gray marginRight40">1.2Km</div>
        </div>
      </div>
    </item>
    <item :leftFlex="1.78" class="itemx2 paddingBot10 hidden">
      ...
      <div
        slot="right"
        class="flexColArd cover marginLeft30 grayBorder"
        :class="{ goLeft: hasGoLeft }"
      >
